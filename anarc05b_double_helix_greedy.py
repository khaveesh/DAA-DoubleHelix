...
class DHG:
    ...
    def solve(self):
        ...
        for i in range(self.arr1[0]):
            ...
            if(bs_val != -1):            
                if(self.flag==0):
                    ...
                    self.result += max(pa1[i]-pa1[prev_max_ind1], pa2[bs_val]-pa2[prev_max_ind2])
        ...
        if self.flag == 0:
            ...
            self.result += max(pa1[self.arr1[0]-1]-pa1[prev_max_ind1], pa2[self.arr2[0]-1]-pa2[prev_max_ind2])
